...
<img src="/media/transit-of-venus-projection.jpg" alt="Photograph of transit projection, sunspots visible" title="Projected with a cheap thrift-store telescope onto a white surface; captured with camera phone. Note the visible sunspots to the left of Venus, the darkest dot." style="float: right; margin-left: 1em;" />
...
[^1]: Camus, The Myth of Sysiphus
[^2]: RIP, Bradbury
[^3]: I am making no statements here on the truthfulness of these theories; true or not, science's current ideas on particles are fascinating.
[^4]: [Some additional conversation on these points](/goddess-of-knowledge-conversation)
